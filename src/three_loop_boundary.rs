...
use crate::{
    ...
    SYMBOLICA_COEFFICIENT_EXPONENT_LIMIT, TwoLoopPipelineError, TwoLoopReductionConfig,
    TwoLoopReductionPipeline, TwoLoopTopDotConfig, TwoLoopTopDotError, TwoLoopTopDotReducer,
    VacuumFamily,
};
...
struct RadialCache<'context> {
    context: &'context crate::CoefficientContext,
...
impl<'context> AngularCache<'context> {
    fn new(context: &'context crate::CoefficientContext, dimension: Coefficient) -> Self {
        Self {
            context,
            dimension,
