...
//!
//! This module is deliberately provenance-neutral.  Symbolica owns determinant,
//! inversion, and multiplication; RustRed supplies only the authenticated
//! coefficient domain, admission policy, typed failure transport, and replay
//! checks needed by proof-bearing callers.
//!
...
pub(crate) struct SymbolicaCoefficientMatrixLimits {
    ...
    /// Largest number of checked scalar operations admitted for the complete
    /// requested matrix operation.
