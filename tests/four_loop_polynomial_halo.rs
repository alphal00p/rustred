...
use rustred::four_loop_polynomial_halo::{
...
use rustred::{
    Coefficient, CoefficientContext, Denominator, ExactRational, FourLoopGenuineClassifier,
    FourLoopGenuineConfig, FourLoopGenuineCornerType, FourLoopGenuineWitness, FourLoopNextManifest,
    FourLoopNextManifestConfig, FourLoopTopology, IbpGenerator, Integral, VacuumFamily,
...
fn independently_convolve(
    ...
    map: &rustred::four_loop_polynomial_halo::FourLoopPolynomialMapWitness,
