...
use rustred::{
    CoefficientContext, Denominator, ExactRational, FourLoopGenuineClassifier,
    FourLoopGenuineConfig, FourLoopGenuineCornerType, FourLoopGenuineError, FourLoopTopology,
    Integral, VacuumFamily,
};
...
fn check_witness(classifier: &FourLoopGenuineClassifier, class: &rustred::FourLoopGenuineClass) {
