...
//! separately proves a tightened or exceptional application box. Fixed-index
//! specialization uses Symbolica's polynomial substitution; a branch may be
//! pruned only when its coefficient is identically zero after that exact
//! substitution.
