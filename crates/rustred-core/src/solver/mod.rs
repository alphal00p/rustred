...
pub use candidate_reduction::{
    ...
    CandidateDomainRouteStats, CandidateEntryAdmission, CandidateOwnerContext, CandidateOwnerInput,
    CandidateOwnerPrograms, CandidateOwnerRoute, CandidateOwnerScope, CandidateReachabilityReport,
    CandidateReducer, CandidateReductionError, CandidateRoutedCampaignError,
    ...
    CandidateRoutedTraceReport, CandidateRoutedWork, CandidateStatistics, CandidateTraceLimits,
    CandidateTraceReport, DomainPowerBounds, DomainPowerError, DomainPowerExtrema,
    DomainPowerSummary, EntryWitnessError, EntryWitnessLimits, EntryWitnessOutcome,
    FiniteRootAdmission, OwnerAppliedCellRefinement, OwnerAppliedError, OwnerAppliedEvent,
    ...
    OwnerSuccessorStats, OwnerSuccessorTransition, RootAdmissionError, RootRegionInput,
