...
def family_candidates(
    ...
    *,
    ...
    case_max_work_items: int | None = None,
    case_max_terms_per_conjunction: int | None = None,
    case_max_normalizations: int | None = None,
    case_max_factorizations: int | None = None,
